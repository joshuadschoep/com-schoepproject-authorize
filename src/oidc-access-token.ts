...
const validateAndGetTokenPayload = (accessToken: any): JWTPayload | undefined => {
...
const validateRequiredPayloadScopes = (payload?: JWTPayload): JWTPayload | undefined => {
    requiredScopes("read:dev")(payload);
    return payload;
}

export const validateToken = (accessToken: any): JWTPayload | undefined =>
    validateRequiredPayloadScopes(
        validateAndGetTokenPayload(accessToken)
    )
